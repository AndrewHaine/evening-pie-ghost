...
/* harmony default export */ __webpack_exports__["a"] = ({
  GHOST_ENDPOINT: "http://ghost:2368/",
  GHOST_CLIENT: "ghost-frontend",
  GHOST_SECRET: "fae5f0afc0dd"
});

/***/ }),

/***/ "./lib/Ghost/utils/Client.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_js__ = __webpack_require__("./config.js");
...
function () {
  function Client() {
    ...
    this.endpoint = __WEBPACK_IMPORTED_MODULE_1__config_js__["a" /* default */].GHOST_ENDPOINT;
    this.clientId = __WEBPACK_IMPORTED_MODULE_1__config_js__["a" /* default */].GHOST_CLIENT;
    this.clientSecret = __WEBPACK_IMPORTED_MODULE_1__config_js__["a" /* default */].GHOST_SECRET;
  }

  _createClass(Client, [{
    key: "_buildURL",
    value: function _buildURL(path, options) {
      var query = __WEBPACK_IMPORTED_MODULE_0_qs___default.a.stringify(_objectSpread({
        client_id: this.clientId,
        client_secret: this.clientSecret
      }, options));
      return "".concat(this.endpoint, "/ghost/api/v0.1").concat(path, "?").concat(query);
    }
  }, {
    key: "getPosts",
    ...
    value: function getPostById(id) {
      return this._buildURL("/posts/".concat(id));
    }
  }, {
    key: "getPostBySlug",
    value: function getPostBySlug(slug) {
      return this._buildURL("/posts/slug/".concat(slug));
    }
  }, {
    key: "getTags",
    ...
    value: function getTagById(id) {
      return this._buildURL("/tags/".concat(id));
    }
  }, {
    key: "getTagBySlug",
    value: function getTagBySlug(slug) {
      return this._buildURL("/tags/slug/".concat(slug));
    }
  }, {
    key: "getUsers",
    ...
    value: function getUserById(id) {
      return this._buildURL("/users/".concat(id));
    }
  }, {
    key: "getUserBySlug",
    value: function getUserBySlug(slug) {
      return this._buildURL("/users/slug/".concat(slug));
    }
  }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lib_Ghost_utils_Client__ = __webpack_require__("./lib/Ghost/utils/Client.js");
...
var Ghost = new __WEBPACK_IMPORTED_MODULE_4__lib_Ghost_utils_Client__["a" /* default */]();
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
        ...
        }, post.title), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_next_link___default.a, {
          href: {
            pathname: "/post",
            query: {
              slug: post.slug
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(Ghost.getPosts());
